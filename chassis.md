...
| Caliper brackets | **Bespoke billet radial brackets — confirmed 2026-07: no ready-made 100 mm radial bracket exists for the FG 621.** (Rebuffini's FG620/621 bracket is axial 69 mm/292 mm; their radial line fits only their inverted forks at 108 mm; Runstock's radial kit is Thailand-sourced, specs unpublished.) 100 mm caliper pitch, set to the 320 mm disc radius, fully metric; fabricate in Step 2 alongside the yokes/stem billet run | `[BESPOKE]` |
