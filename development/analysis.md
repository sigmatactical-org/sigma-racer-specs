...
- **Execution: 0%** — no mule bought, no firmware written, no part fabricated. T0 (mule buy) is ~2 months out (Sep 2026).

The gap between the first line and the other two *is* the honest status: **the bike is well-designed; the business has produced its first (unfavourable) data point; the doing has not yet begun.**
